...
<!--    </form>-->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" @click.prevent="fullScrBtn()" data-widget="fullscreen" href="#" role="button">
...
<script>
    export default {
      ...
      methods: {
        ...
        fullScrBtn() {
          let FullscreenBtn = document.querySelector('a[data-widget="fullscreen"] i')
          if (FullscreenBtn.classList.contains('fa-expand-arrows-alt')) {
            FullscreenBtn.classList.remove('fa-expand-arrows-alt')
            FullscreenBtn.classList.add('fa-compress-arrows-alt')
            this.openFullscreen()
          } else {
            FullscreenBtn.classList.remove('fa-compress-arrows-alt')
            FullscreenBtn.classList.add('fa-expand-arrows-alt')
